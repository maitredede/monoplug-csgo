...
struct ClientUIFunctions {
	...
	void (*onTalkStatusChangeEvent)              (uint64 serverConnectionHandlerID, int status, anyID clientID);
	...
	void (*onCustomCaptureDeviceCloseEvent)      (uint64 serverConnectionHandlerID, void* fmodSystem);
	void (*onCustomPlaybackDeviceCloseEvent)     (uint64 serverConnectionHandlerID, void* fmodSystem);
...
EXPORTDLL unsigned int ts3client_openPlaybackDevice(uint64 serverConnectionHandlerID, int modeID, const char* playbackDevice);
EXPORTDLL unsigned int ts3client_openCaptureDevice(uint64 serverConnectionHandlerID, int modeID, const char* captureDevice);
EXPORTDLL unsigned int ts3client_openCustomPlaybackDevice(uint64 serverConnectionHandlerID, void* fmodSystem);
EXPORTDLL unsigned int ts3client_openCustomCaptureDevice(uint64 serverConnectionHandlerID, void* fmodSystem, int fmodDriverID);
EXPORTDLL unsigned int ts3client_getCurrentPlaybackDeviceName(uint64 serverConnectionHandlerID, char** result);
EXPORTDLL unsigned int ts3client_getCurrentPlaybackDevice(uint64 serverConnectionHandlerID, void** fmodSystemResult);
EXPORTDLL unsigned int ts3client_getCurrentPlayBackMode(uint64 serverConnectionHandlerID, int* result);
EXPORTDLL unsigned int ts3client_getCurrentCaptureDeviceName(uint64 serverConnectionHandlerID, char** result);
EXPORTDLL unsigned int ts3client_getCurrentCaptureDevice(uint64 serverConnectionHandlerID, void** fmodSystemResult);
EXPORTDLL unsigned int ts3client_getCurrentCaptureMode(uint64 serverConnectionHandlerID, int* result);
...
EXPORTDLL unsigned int ts3client_activateCustomCaptureDevice(uint64 serverConnectionHandlerID, void* fmodSystem, int fmodDriverID);
...
EXPORTDLL unsigned int ts3client_fmod_Systemset3DListenerAttributes(uint64 serverConnectionHandlerID, const TS3_FMOD_VECTOR* position, const TS3_FMOD_VECTOR* velocity,
                                                                    const TS3_FMOD_VECTOR* forward, const TS3_FMOD_VECTOR* up);
EXPORTDLL unsigned int ts3client_fmod_Systemset3DSettings(uint64 serverConnectionHandlerID, float dopplerScale, float distanceFactor, float rolloffScale);
EXPORTDLL unsigned int ts3client_fmod_Channelset3DAttributes(uint64 serverConnectionHandlerID, anyID clientID, const TS3_FMOD_VECTOR* position, const TS3_FMOD_VECTOR* velocity);
...
EXPORTDLL unsigned int ts3client_requestChannelSubscribe(uint64 serverConnectionHandlerID, uint64 channelID, const char* returnCode);
EXPORTDLL unsigned int ts3client_requestChannelSubscribeAll(uint64 serverConnectionHandlerID, const char* returnCode);
EXPORTDLL unsigned int ts3client_requestChannelUnsubscribe(uint64 serverConnectionHandlerID, uint64 channelID, const char* returnCode);
...
EXPORTDLL unsigned int ts3client_flushClientSelfUpdates(uint64 serverConnectionHandlerID);
