...
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
public delegate void onTalkStatusChangeEvent_type(uint64 serverConnectionHandlerID, int status, anyID clientID);
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
...
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
public delegate void onCustomCaptureDeviceCloseEvent_type(uint64 serverConnectionHandlerID, IntPtr/*void* */ fmodSystem);
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
public delegate void onCustomPlaybackDeviceCloseEvent_type(uint64 serverConnectionHandlerID, IntPtr/*void* */ fmodSystem);
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
public delegate void onFMODChannelCreatedEvent_type(uint64 serverConnectionHandlerID, anyID clientID, IntPtr/*void**/ fmodChannel);
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
...
public static class callback {
	...
	*/
	public static void onTalkStatusChangeEvent(uint64 serverConnectionHandlerID, int status, anyID clientID) {
		string name;
		IntPtr namePtr = IntPtr.Zero;
		/* Query client nickname from ID */
		uint error = ts3client.ts3client_getClientVariableAsString(serverConnectionHandlerID, clientID, ClientProperties.CLIENT_NICKNAME, out namePtr);
