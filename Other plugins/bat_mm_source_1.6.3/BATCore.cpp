...
bool g_ListenForChatCommands = true;
...
bool BATCore::Load(PluginId id, ISmmAPI *ismm, char *error, size_t maxlen, bool late)
{
	...
	{		
		...
		AddLogEntry("Warning: The plugin may have been Late loaded, if it was loaded by meta load command please change map now. If not ignore this");
	}	return true;
}
