...
namespace MonoPlug
{
    partial class ClsPluginEvents
    {
        ...
        {
            add { this.Attach(Events.ConsoleMessage, value, this._anchor.ConsoleMessage_Attach); }
            remove { this.Detach(Events.ConsoleMessage, value, this._anchor.ConsoleMessage_Detach); }
        }
    }
}
