...
namespace MonoPlug
{
    internal sealed partial class ClsPluginEvents : MarshalByRefObject, IEvents
    {
        ...
        private readonly IEventsAttach _anchor;

        internal ClsPluginEvents(ClsPluginBase owner, IEventsAttach anchor)
        {
#if DEBUG
