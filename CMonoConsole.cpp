...
{
	CMonoConsole::CMonoConsole(CMonoPlugin* plug)
	{
		this->m_plug = plug;
	}
	...
	void CMonoConsole::MonoPrint(bool hasColor, bool debug, int r, int g, int b, int a, const char *msg)
	{
		...
		args[4] = &b;
		args[5] = &a;
		args[6] = CMonoHelpers::GetString(g_Domain, msg);
		CMonoHelpers::CallMethod(this->m_plug->m_main, this->m_plug->m_ClsMain_ConPrint, args);
	}
}
