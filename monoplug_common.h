...
#define MONOPLUG_CALLBACK_REGISTERCONCOMMAND "MonoPlug.ClsMain:Mono_RegisterConCommand(string,string,ConCommandDelegate)"
#define MONOPLUG_CALLBACK_UNREGISTERCONCOMMAND "MonoPlug.ClsMain:Mono_UnregisterConCommand(string,string,ConCommandDelegate)"
